...
// Programa interativo para testar um algoritmo de ordenação por vez
int main() {
    ...
    // Lê o tamanho do vetor e a seed usados para gerar dados de teste
    ...
    do {
        ...
        // Gera o vetor de teste no formato selecionado
        switch (tipoVetor) {
            case 1:
            ...
            case 3:
                ...
                break;
            case 4:
                vetor = geraQuaseOrdenados(tam, seed, 90);
                break;
            default:
        ...
        // Executa o algoritmo escolhido e registra métricas e tempo
        if (opcao == 1) {
            t1 = clock();
        ...
        // Pergunta ao usuário se o vetor ordenado deve ser salvo em arquivo
